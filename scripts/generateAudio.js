...
async function generateAudio() {
  console.log('🎙️ Generating natural voice audio...');

  try {
    // Using "Drew" - a younger, more conversational male voice
    const response = await fetch(
      'https://api.elevenlabs.io/v1/text-to-speech/29vD33N1CtxCmqQRPOHJ', // Drew voice
      {
        ...
        body: JSON.stringify({
          ...
          voice_settings: {
            stability: 0.4, // Lower for more variation and naturalness
            similarity_boost: 0.85, // Higher for more character
